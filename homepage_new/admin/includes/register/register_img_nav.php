...
$image_sizes = getimagesize($_FILES['img_link_nav']['tmp_name']);

//1. strrchr renvoie l'extension avec le point (« . »).
//2. substr(chaîne,1) ignore le premier caractère de chaîne.
//3. strtolower met l'extension en minuscules.
$extension_upload = strtolower(  substr(  strrchr($_FILES['img_link_nav']['name'], '.')  ,1)  );

if ($_FILES['img_link_nav']['error'] > 0) $erreur = "Erreur lors du transfert";
if ($_FILES['img_link_nav']['size'] > $maxsize) $erreur = "Le fichier est trop gros";
